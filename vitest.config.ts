...
export default defineConfig({
  ...
  test: {
    ...
    coverage: {
      ...
      include: ['src/domain/**/*.ts', 'src/api/**/*.ts', 'src/metrics/**/*.ts', 'src/auth/service.ts', 'src/auth/session.ts', 'src/auth/session-adapter.ts', 'src/auth/payload-resolver.ts', 'src/auth/email-confirm.ts', 'src/auth/email-worker.ts', 'src/auth/password-reset.ts', 'src/auth/rate-limit.ts', 'src/email/**/*.ts', 'src/classes/**/*.ts', 'src/assignments/**/*.ts', 'src/attempts/**/*.ts', 'src/students/service.ts', 'src/security/**/*.ts', 'src/content/**/*.ts'],
